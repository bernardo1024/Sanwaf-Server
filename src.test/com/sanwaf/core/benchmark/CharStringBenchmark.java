...
/**
 * Benchmark comparing 2 approaches for extracting a single-character String: 1.
 * Current (before): key.substring(0, 1) — allocates a new String each call 2.
 * Cached charString(): lookup in a pre-built String[128] array — zero
 * allocation for ASCII
 *
...
public class CharStringBenchmark {
  ...
  // --- Test data ---
  private static final String[] KEYS = { "username", "password", "email", "firstName", "lastName", "address", "city", "state", "zip", "phone", "company", "title", "department", "role", "token",
      "sessionId", "csrfToken", "rememberMe", "locale", "timezone", "x-forwarded-for", "content-type", "authorization", "accept", "cookie", };
