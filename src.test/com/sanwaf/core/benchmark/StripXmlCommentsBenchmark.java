...
/**
 * Benchmark comparing approaches for stripping XML comments: 1. Current — two
 * String.replaceAll() calls (compiles regex each call) 2. Precompiled Pattern —
 * static final Pattern for both regexes 3. indexOf loop — single-pass scan for
 * <!-- and --> markers
 */
...
public class StripXmlCommentsBenchmark {
  ...
  private static final String TEST_INPUT_SINGLE_LINE = "<root>\n" + "  <!-- this is a comment -->\n" + "  <name>value</name>\n" + "  <!-- another comment -->\n" + "  <other>data</other>\n"
      + "</root>";

  private static final String TEST_INPUT_MULTI_LINE = "<root>\n" + "  <!--\n" + "    this is a\n" + "    multi-line comment\n" + "  -->\n" + "  <name>value</name>\n" + "  <!--\n" + "    another\n"
      + "    multi-line\n" + "  -->\n" + "  <other>data</other>\n" + "</root>";

  private static final String TEST_INPUT_MIXED = "<root>\n" + "  <!-- single line -->\n" + "  <name>value</name>\n" + "  <!--\n" + "    multi-line comment\n" + "  -->\n" + "  <other>data</other>\n"
      + "  <!-- another single line -->\n" + "  <last>item</last>\n" + "</root>";

  private static final String TEST_INPUT_NO_COMMENTS = "<root>\n" + "  <name>value</name>\n" + "  <other>data</other>\n" + "</root>";
